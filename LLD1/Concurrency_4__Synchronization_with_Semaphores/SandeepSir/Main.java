...
public class Main {
    public static void main(String[] args) {
        ...
        Producer p1 = new Producer(store, 5, "P1", semaProducer, semaConsumer);
        Producer p2 = new Producer(store, 5, "P2", semaProducer, semaConsumer);
        Producer p3 = new Producer(store, 5, "P3", semaProducer, semaConsumer);
        Producer p4 = new Producer(store, 5, "P4", semaProducer, semaConsumer);
        Producer p5 = new Producer(store, 5, "P5", semaProducer, semaConsumer);
